...
@Injectable()
export class BookingReleasedEmailTemplate extends BaseEmailTemplate<BookingNotificationData> {
  protected buildSubject(data: BookingNotificationData): string {
    return `Booking Released: ${data.roomName}`;
  }
  ...
  protected buildHtml(data: BookingNotificationData): string {
    ...
    return `
      <div style="font-family:Arial,sans-serif;line-height:1.5;color:#111;">
        <p>Hello ${data.name},</p>
        <p>Your booking has been <strong>released</strong>.</p>
