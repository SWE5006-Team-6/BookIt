...
describe('BookingService', () => {
  ...
  describe('create', () => {
    ...
    it('should throw InternalServerErrorException on P2021 (table not found)', async () => {
  ...
  describe('update', () => {
    ...
    it('should throw BadRequestException when updating time with invalid range', async () => {
      const invalidUpdateDto = {
        startAt: '2026-02-10T11:00:00Z',
  ...
  describe('cancel', () => {
    ...
    it('should throw BadRequestException when booking already cancelled', async () => {
      ...
      mockBookingRepository.findById.mockResolvedValueOnce(cancelledBooking);
